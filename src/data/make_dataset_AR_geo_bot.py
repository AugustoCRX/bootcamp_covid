...
def main(output_filepath):
    ...
    print("\nStarting Argentina's dataset...")
    """ Runs data processing scripts to turn raw data from (../raw) into
        cleaned data ready to be analyzed (saved in ../processed).
    """
    print('Reading data...')
    caminho_AR = r"{}\data\external\twitter\ARGENTINA\DATA".format(project_dir)
    ...
    geo_path = r"{}\data\external\twitter\ARGENTINA\GEO".format(project_dir)
    ...
    AR_df.to_csv(r'{}\data\bronze\twitter_bronze\AR_raw_data.csv'.format(output_filepath))
    print("Finishing Argentina's dataset...\n")
