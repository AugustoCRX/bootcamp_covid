 ...
 */
    if (!(likely(PyList_CheckExact(__pyx_v_p_probs))||((__pyx_v_p_probs) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_p_probs)->tp_name), 0))) __PYX_ERR(0, 285, __pyx_L1_error)
